...
export const styleModels: StyleModel[] = [
  ...
  {
    // /gomgom-infographic의 구조 락과 톤을 맞춘 프리셋
    // (일괄 제작은 그 스킬로, 여기서는 한 장을 손으로 다듬을 때)
    id: "proposal",
    name: "제안서 슬라이드",
    imageSrc: "/images/styles/kr-proposal.png",
    prompt:
      "제안서용 인포그래픽 슬라이드, A4 가로 구도. 순백색 배경, 상단에 얇은 컬러 헤더 바와 굵은 산세리프 타이틀 자리, 그 아래 가는 골드 가로 디바이더. 본문은 모서리가 둥근 흰 카드 3~4개를 가로로 나란히 배치하고 카드마다 단순한 선 아이콘과 원형 컬러 배지. 톤다운된 색 3개에 액센트 1개만 쓰는 절제된 배색(다크 네이비·골드 계열), 여백을 넉넉히. 평면적이고 정갈한 공공 제안서 톤, 사진·그라데이션·그림자 남용 없이. 회사명이나 로고는 넣지 말 것",
  },
  {
    id: "cardnews",
    name: "카드뉴스",
